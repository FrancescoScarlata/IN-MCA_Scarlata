		...
		try:
			...
			if len(faces) == 1:
				for (x,y,w,h) in faces:
					...
					fronte = frame[y+inizioY: y+reduceHeigh, x+fronteX: x+reducedWidth]
			...
			print("[exception GreenElaboration] At frame: "+ str(currentFrame)+" of "+str(videoLen) +" there is no frame. Terminating...")
